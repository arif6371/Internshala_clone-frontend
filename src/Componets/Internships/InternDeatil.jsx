  ...
  const submitApplication = async () => {
    ...
    if (text.value === "") {
      ...
      const bodyJson = {
        ...
        company: company,
        user: user,
        location: location,  // Include location in the submission
        Application: id
      }
      ...
      navigator.geolocation.getCurrentPosition((position) => {
        ...
        fetch(`https://geocode.xyz/${lat},${lon}?geoit=json`)
          ...
          .then(data => {
            ...
            alert(`Location tracked: ${data.city}, ${data.state}, ${data.country}`);
          })
          .catch(() => alert("Unable to fetch location details"));
      });
    } else {
          ...
          <div className="application-page">
            ...
            <div className="moreSteps">
              ...
              <div className="submit flex justify-center">
                <button className='submit-btn' onClick={getLocation}>Track Location</button> {/* Track Location Button */}
              </div>
